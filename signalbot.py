...
from code_reader import get_code_context, get_file_context
...
def main():
    ...
    print("2. Claude Haiku 4.5 (API, ~$0.006/msg, fast)")
    print("3. Phi3 (local, free, UNSTABLE)")
    print("4. Mistral 7b (local, free, 120-220s response, Signalbot's 3rd choice')")
    print("5. Llama 3.1 (Model too big, times out)")
    print("6. Mistral Medium (API but limited free)")
    while True:
    ...
    print("Commands: 'state', 'facts', 'daemon', 'curiosity', 'modes', 'archive', 'plans', 'dream on/off', 'speech on/off', 'exit', 'read code'")
